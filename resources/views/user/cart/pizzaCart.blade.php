                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    ...
                                    <input type="text" class="form-control form-control-sm bg-dark border-0 text-white text-center" value="{{$cart->qty}}">
                                    <div class="input-group-btn">
                            ...
                            <td class="align-middle">{{$cart->pizzaPrice*$cart->qty}}</td>
